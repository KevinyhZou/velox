...
class RowReaderOptions : public dwio::common::ReaderOptions, public dwio::common::RowReaderOptions {
public:
    RowReaderOptions(
...
private:
    ...
    const void deserialize(VectorPtr& field, const TypePtr& type, const size_t index, const std::string& s);
};
