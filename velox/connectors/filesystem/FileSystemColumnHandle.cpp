...
namespace facebook::velox::connector::filesystem {
    ...
    std::string FileSystemColumnHandle::toString() const {
        ...
        boost::algorithm::replace_all(s, "HiveColumnHandle", "FileSystemColumnHandle");
        return s;
    }
    ...
    folly::dynamic FileSystemColumnHandle::serialize() const {
        ...
        const std::vector<common::Subfield>& subFields = hive::HiveColumnHandle::requiredSubfields();
    ...
    ColumnHandlePtr FileSystemColumnHandle::create(const folly::dynamic& obj) {
        ...
        return std::make_shared<FileSystemColumnHandle>(name, columnType, dataType, std::move(requiredSubfields));
    }
