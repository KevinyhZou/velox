...
class GeneratedExpressionStruct {
 public:
  GeneratedExpressionStruct(
      ...
      const RowType& outputRowTypeArg,
      ...
      : 
        ...
        outputImplType_(codegenUtils::codegenImplTypeName(outputRowTypeArg)),
 ...
 private:
  std::shared_ptr<RowType> inputRowType_;

  std::shared_ptr<RowType> outputRowType_;
